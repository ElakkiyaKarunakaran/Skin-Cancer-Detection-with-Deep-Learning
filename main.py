...
# %%
BASE_DIR = "C:\skin cancer detection"  # Change based on your dataset location
...
model = load_model('skin_cancer_cnn.h5', compile= False)
...
# %%
predict_skin_cancer(r"C:\skin cancer detection\test\Malignant\5616.jpg", model)

# %%
predict_skin_cancer(r"C:\skin cancer detection\train\Malignant\1004.jpg", model)
